...
/* package lucians-luscious-lasagna-1.0.0.0 */
#ifndef VERSION_lucians_luscious_lasagna
#define VERSION_lucians_luscious_lasagna "1.0.0.0"
#endif /* VERSION_lucians_luscious_lasagna */
#ifndef MIN_VERSION_lucians_luscious_lasagna
#define MIN_VERSION_lucians_luscious_lasagna(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_lucians_luscious_lasagna */
...
#define CURRENT_PACKAGE_KEY "lucians-luscious-lasagna-1.0.0.0-BTD4QnG0d9xBUPnAXTE27f"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "lucians-luscious-lasagna-1.0.0.0-BTD4QnG0d9xBUPnAXTE27f"
