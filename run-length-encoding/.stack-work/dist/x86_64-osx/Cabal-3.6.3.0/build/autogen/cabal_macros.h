...
#define CURRENT_PACKAGE_KEY "run-length-encoding-1.1.0.5-8BMlkOKkLFq3GbwOBDRfzI"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "run-length-encoding-1.1.0.5-8BMlkOKkLFq3GbwOBDRfzI"
